...
def build_runner_script(path: Path, simple_trainer: Path, package_dir: Path, output_root: Path, image_dir: str, sparse_dir: str, steps: int, strategy: str) -> None:
...
def run_vksplat(package_dir: Path, output_root: Path, vksplat_root: Path, steps: int = 30000, image_dir: str = "images", sparse_dir: str = "sparse/0", strategy: str = "mcmc", dry_run: bool = False) -> dict[str, Any]:
    ...
    build_runner_script(runner, simple_trainer, package_dir, output_root, image_dir, sparse_dir, steps, strategy)
...
def main(argv: list[str] | None = None) -> None:
    ...
    summary = run_vksplat(args.package, args.out, args.vksplat_root, args.steps, args.image_dir, args.sparse_dir, args.strategy, args.dry_run)
